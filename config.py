...
# Bot Configuration
OWNER_ID = 7807437342  # Replace with your actual Telegram user ID
TOKEN = "7778281937:AAFMaZFRYnrVGqPRqHTwbgEaPwBIO_jVVnc"  # Telegram Bot Token
...
BOT_THEME = {
    "title_font": "ᴇxᴘ ʙɢᴍɪ ᴜɪᴅ ᴄʜᴇᴄᴋᴇʀ ʙᴏᴛ",
    "symbols": {
        "success": "✅",
        "error": "❌",
        "warning": "⚠",
